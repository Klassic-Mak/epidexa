...
''';
  ...
  Future<String> sendMessageWithImageBase64(
    ...
    if (!validation.toUpperCase().startsWith('VALID')) {
      return isVietnamese
          ? 'Ảnh này không phù hợp để phân tích da. Vui lòng chụp ảnh rõ vùng da, đủ sáng và không bị mờ.'
          : 'This image is not suitable for skin analysis. Please take a clear, well-lit photo of the skin area.';
    }
